...
if(substr($class,0,6)=="senior" || substr($class,0,6)=="SENIOR")
{
    $h = 7;
...
foreach($subjects as $sub)
{
    ...
    { 
        foreach($m as $n)
        {
            $pdf->cell(13.333,6,$n,1,0);
            $pdf->cell(13.333,6,$n,1,0);

            $pdf->cell(13.333,6,$n*2,1,0);
        }}
        ...
        foreach($op_test as $sub_op){
            foreach($sub_op as $sub_sub_op)
            {
                ...
                $pdf->cell(13.333,6,$sub_sub_op,1,0);
                $test = $sub_sub_op;
                $pdf->SetFont("Arial","",12);
            }
        }
...
$max = $max * 2;
$pdf->cell(45,6,"Average ",1,0);
$avg = ($optimum/$max)*100;
$avg=round($avg,2);
$pdf->cell(40,6,$avg."%",1,0);
$pdf->cell(26.777777777,7,"Rank ",1,0);
$pdf->cell(28.333333333,7,$general_rank." out of ".$class_size,1,1);
$pdf->cell(70,10,"Observations","TLR",0);
$pdf->cell(70,10,"Teacher Signature",1,1);
$pdf->cell(70,10," ","BLR",0);
$pdf->cell(70,10,"Parent Signature",1,0);
